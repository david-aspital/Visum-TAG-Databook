...
Example model and Python script to add tables from the TAG databook into PTV Visum as User-Defined Tables. The example model uses the May 2025 version of the databook (v2.01) with default Price and Value years (2010). 
